...
const UpdateProduct = ({ product, setEditProduct, products, setProducts, setError, error }) => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    if (
      ...
      editProductState.manufacturer &&
      editProductState.price &&
      editProductState.experienceDate &&
      editProductState.quantity
    ) {
      try {
        console.log('Sending PUT request to:', `/prods/products/${editProductState.id}`);
        console.log('Request body:', {
          ...editProductState,
          experienceDate: formatDate(editProductState.experienceDate),
        });

        const response = await fetch(`/prods/products/${editProductState.id}`, {
          method: 'PUT',
